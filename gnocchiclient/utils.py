...
resource_binary_operator = (u">=", u"<=", u"!=", u">", u"<", u"=", u"==", u"eq", u"ne",
                   u"lt", u"gt", u"ge", u"le", u"in", u"like", u"≠", u"≥", u"≤")
metric_binary_operator = (u">=", u"<=", u"!=", u">", u"<", u"=", u"==", u"eq", u"ne",
                   u"lt", u"gt", u"ge", u"le", u"≠", u"≥", u"≤")
...
def resource_query_builder(query):
    ...
    resource_condition = pp.Group(comparison_term + resource_operator + comparison_term)
