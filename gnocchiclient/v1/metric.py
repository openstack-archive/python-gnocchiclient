...
class MetricManager(base.Manager):
    ...
    def aggregation(self, metrics, query=None,
                    ...
                    needed_overlap=None, query_resource_type="generic"):
        ...
        :param aggregation: aggregation to retrieve
        :type aggregation: str
        :param query_resource_type: type of resource for the query
        :type query_resource_type: str
