...
class MetricClientTest(base.ClientTestBase):
    ...
    def test_metric_scenario(self):
        ...
        self.gnocchi('measures', params=("--debug batch %s" % tmpfile.name))
        #self.gnocchi('measures', params=("batch -"), input=measures)
    ...
    def test_metric_by_name_scenario(self):
        ...
        with tmpfile as f:
            f.write(json.dumps(measures))
        self.addCleanup(os.remove(tmpfile.name))
        self.gnocchi('measures', params=("batch %s" % tmpfile.name))
        #self.gnocchi('measures', params=("batch -"), input=measures)
